...
const Details = ({ position, company, companyLink, time, address, work }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-8 first:mt-0 last:mb-0 w-[60%] md:w-[80%] sm:mx-auto flex flex-col items-center justify-between"
    >
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-center justify-between ml-4 xs:ml-2">
          <Details
            ...
            address={
              "MIG 401, 11th Cross Road, Panampilly Nagar, Kochi, Kerala, India, 682036"
            }
            ...
            work={
              <ul>
                ...
                <li>
                  Maintain high-quality standards for the work undertaken.
                </li>
                <li>Responsible for the quality of deliverables.</li>
                <li>Enough test automation and code coverage.</li>
                <li>
                  Drive architectural changes on frontend architecture by
                  profiling.
                </li>
                <li>Improved UX, and build with the design system.</li>
              </ul>
            }

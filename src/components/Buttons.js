export const Button1 = ({ name }) => {
  return (
    <div  className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 md:py-2 md:pl-3 md:pr-10 overflow-hidden font-semibold text-dark transition-all duration-150 ease-in-out rounded hover:pl-10 md:hover:pl-8 hover:pr-6 md:hover:pr-4  md:text-base md: bg-light group">
...
<span className="absolute left-0 pl-2.5 md:pl-[5px] -translate-x-12 group-hover:translate-x-0 ease-out duration-200">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5" color="green">
  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
</svg>
...
return(
  <div  className="relative inline-flex items-center justify-start px-6 py-3  md:py-2 overflow-hidden font-medium md:font-base transition-all bg-light rounded hover:bg-light group">
